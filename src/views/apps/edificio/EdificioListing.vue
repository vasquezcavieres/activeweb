<template>
  ...
  <div class="card">
    ...
    <div class="card-header border-0 pt-6">
      <!--begin::Card title-->
      <div class="card-title color-payment"> <strong>Asociar Edificios</strong></div>
      <!--begin::Card title-->
    ...
    <div class="card-body pt-0">
      <DataTable
        ...
        :globalFilterFields="[
          'codigoEdificio','codigoArea','nombre','codigoPais','pais','direccion','ciudad','comuna','centroCosto','rutRazonSocial'
        ]"
      ...
      >
        ...
        <!-- <Column :exportable="false" style="min-width: 8rem">
          <template #body="slotProps">
            ...
            <Prime-Button icon="pi pi-trash" class="p-button-rounded p-button-warning" @click="confirmDeleteEdificio(slotProps.data)" ></Prime-Button>
          </template>
        </Column> -->
      </DataTable>
    </div>
    ...
    <div class="d-flex justify-content-end">
      <router-link
            ...
            :to="{name:'apps-convenio-admin-create', params : {id :rutRazonSocial} }"
          >    
      </router-link>
      <router-link
            class="btn btn-primary pi pi-arrow-right ms-2"
            :to="{name:'apps-cicloTransferencia-edit', params : {id :rutRazonSocial} }"
          >    
      </router-link>
    </div>
  </div>
    ...
    <!--end::Card body-->
    <Dialog v-model:visible="visible" :style="{ width: '60vw' }" header="Crear Edificio" :modal="true">
        ...
        <div id="kt_content_container">
		  ...
		  <Form
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                            ...
                            <div class="col-4">
                              ...
                              <div class="col-4">
                                ...
                                <Field v-slot="{ value }" 
                                  ...
                                  >
                                  <option value="" disabled>Seleccione un Tipo Abono</option>
              ...
              <div class="d-flex justify-content-end">               
                <button class="btn btn-primary  me-5" @click="visible = false"> 
  ...
  <!--end::Layout-->
    ...
    <Dialog  v-model:visible="deleteEdificiosDialog" :style="{width: '450px'}" header="Confirmar" :modal="true">
        <div class="confirmation-content">
            <i class="pi pi-exclamation-triangle mr-3" style="font-size: 2rem" />
            <span>¿Está seguro de asociar los Edificios seleccionados?</span>
        </div>
        <template #footer>
            <Prime-Button label="No" icon="pi pi-times" class="p-button-text" @click="deleteEdificiosDialog = false"/>
            <Prime-Button label="Sí" icon="pi pi-check" class="p-button-text" @click="asociarEdifiiosSeleccionados" />
        </template>
    </Dialog>
  </div>
</template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const getEdificiosConvenio = (rutRazonSocial) => {
      store.getEdificiosConvenio(rutRazonSocial)
        .then(() => {
          loading.value = false;
          selectedEdificios.value = allEdificiosConvenio.value ;         
        })
        .catch(() => {
          const [error] = Object.values(store.edificioErrors);
          Swal.fire({
        ...
        store.asociarEdificios(rutRazonSocial,formData)
          ...
          //  submitButton1.value?.removeAttribute("data-kt-indicator");
            Swal.fire({
              ...
              router.push({ name: "apps-cicloTransferencia-edit", params : { id : rutRazonSocial} });
            });
          })
          .catch(() => {
            const [error] = Object.values(store.edificioErrors);
  ...
  const saveChanges1 = () => {  
      ...
      if (submitButton1.value) {
        ...
        store.createEdificio(edificioDetails.value)
          .then(() => {
            buscarEdificios();
            getEdificiosConvenio(rutRazonSocial);
            toast.add({ severity: 'info', summary: 'Info', detail: 'Edificio Creado', life: 3000 });
            setTimeout(() => {
                  deleteEdificioDialog.value = false;
              }, 2000)
           // loading = ref(false);
          ...
          .catch(() => {
            const [error] = Object.values(store.edificioErrors);
            toast.add({ severity: 'info', summary: 'Info', detail: 'Problemas al crear Edificio', life: 3000 });
          });
      }
    };
    ...
    return {saveChanges1,edificiosValidator,asociarEdificio,visible,
      edificioDetails,
      crearEdificio,
      filters1,
      selectedEdificios,

...
export default defineComponent({
  ...
  setup() {
    ...
    const usuariosValidator = Yup.object().shape({
      ...
      codigoRol :Yup.string().required("Es obligatorio").label("codigoRol"),
...
const calculaDvUsuario = (rut) => {
  ...
  const allEdificios = computed(() => {
    ...
    const cities = ref([
    { name: 'ADMINISTRADOR_CONVENIO', code: 'ADMINISTRADOR_CONVENIO' },
    { name: 'COMUNIDAD', code: 'COMUNIDAD' },
]);
    ...
    return {cities,mostrarEdificios
      ,
      seleccionPerfil,
      buscarEdificios,
      allEdificios,

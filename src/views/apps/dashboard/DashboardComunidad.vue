...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      onMounted(async () => {        
       ...
       await obtenerEdificioConvenio(authStore.user.rutUsuario) ; 
   
        getDashboard(edificioDetails.value.codigoEdificio);
        getDashboardSinFacturar(edificioDetails.value.codigoEdificio);
     ...
     const  obtenerEdificioConvenio = async(id) =>{
      ...
      const getDashboard = (codigoConvenio) => {
        ...
        dashboardDetails.value.codigoConvenio = 0;
        dashboardDetails.value.codigoEdificio  = edificioDetails.value.codigoEdificio;
    ...
    const getDashboardSinFacturar = (codigoConvenio) => {
      dashboardSinFacturarDetails.value.codigoConvenio = 0;
      dashboardSinFacturarDetails.value.codigoEdificio  = edificioDetails.value.codigoEdificio;
  ...
  const buscarTransferencias = () => {
    storeTransferenciaStore.getTransferenciaPorEdificio(edificioDetails.value.codigoEdificio)
        .then(() => {
          loading.value = false;
...
menu.value.toggle(event);
    ...
    const formatCurrency = (value) => {
      ...
      return {obtenerEdificioConvenio,

<template>
  ...
  <div class="d-flex flex-column flex-lg-row flex-column-fluid">
    ...
    >
      ...
      <!--begin::Footer-->
      <div class="d-none d-flex flex-center flex-wrap px-5">
        <!--begin::Links-->
    ...
    >
      ...
      >
        ...
        <img
          ...
          :src="getAssetPath('media/misc/auth-screens.jpg')"
          alt=""
        />
        <!--end::Image-->
        ...
        <!--begin::Title-->
        <h1
          class="d-none d-lg-block_ text-white fs-2qx fw-bolder text-center mb-7"
        >
        ...
        <!--begin::Text-->
        <div class="d-none d-lg-block_ text-white fs-base text-center">

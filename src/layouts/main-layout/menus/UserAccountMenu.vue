<template>
  ...
  >
      ...
      <div class="menu-content d-flex align-items-center px-3">
        ...
        <div class="d-flex flex-column">
          <div class="fw-bold d-flex align-items-center fs-5">
            {{ usuarioLogin.nombres +' '+ usuarioLogin.apellidos}}
            
          </div>
          <a href="#" class="fw-semobold text-info text-hover-primary fs-7"
            >    {{ usuarioLogin.email }}</a
          >
        </div>
        <!--end::Username-->
      </div>
    ...
    <!--begin::Menu item-->
    <div class="d-none menu-item px-5 my-1">
      <router-link to="/pages/profile/overview" class="menu-link px-5">
        Account Settings
      </router-link>
    </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const usuarioLogin = ref<User>({    
      ...
      password:'',
      api_token: store.user.api_token,
      clave:'',
      tokenAcceso: ''
  });
